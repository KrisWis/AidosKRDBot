...
class ConcertMusicOrm(Base):
    ...
    __table_args__ = (
        UniqueConstraint('id', name='unique_concert_music_item'),
    )


# Таблица c данными о скидках
class RebatesOrm(Base):
    ...
    __table_args__ = (
        UniqueConstraint('id', name='unique_rebate'),
    )


# Таблица c данными об акциях
